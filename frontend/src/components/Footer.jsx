      ...
      <div className="container mx-auto px-6 sm:px-12 md:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mb-10">
          ...
          <div className="flex flex-col items-start gap-5">
            ...
            Connecting you with expert doctors, ensuring accessible care, and delivering a healthier tomorrow for you and your family.
            </p>
          </div>
        ...
        <div className="border-t pt-6">
          <p className="text-center text-sm text-gray-500">
            Copyright 2024 @ bitmesra.ac.in - All Rights Reserved.
          </p>
        </div>
